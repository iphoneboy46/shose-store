...
function renderProduct(albums){
    ...
    var htmlsss = albums.map(function (album){
       if(album.id <= 6){
        return `
        <div class="section__product-item product_0${album.id} col l-4 m-4" data-aos="zoom-in">
...
function handleAddCart(id){
   var items = document.querySelector('.product_0id');
   console.log("🚀 ~ file: app.js ~ line 136 ~ handleAddCart ~ items", items)
}
