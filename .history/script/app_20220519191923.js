...
function updateShoppingCartHTML(){
    ...
    let result = productInCart.map(function(product){
            ...
            <div class="cart-details col l-6">
                ...
                <div class="quantity">
                    <input type="button" class="btn-minus" onClick="Minus(${product.name})" value="-">
                    <span class="num">${product.number}</span>
                    <input type="button" class="btn-plus"  onClick="Plus(${product.name})" value="+">
                </div>
            </div>
