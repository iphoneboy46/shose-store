...
function renderProduct(albums){
    ...
    var htmlsss = albums.map(function (album){
       if(album.id <= 6){
        return `
        <div class="section__product-item id="${album.id}" col l-4 m-4" data-aos="zoom-in">
        ...
        <div class="product__description">
            ...
            <div class="product__cart">
                <button onclick="handleAdd(${album.id})" ><i class="fa-solid fa-cart-plus"></i></button>
            </div>
