        ...
        .then(function(cards){ 
            ...
            <div class="row">
                ...
                <div class="cart-details col l-6">
                    ...
                    <div class="quantity">
                        <input type="button" class="minus" onclick="Minus(${cards.id})" value="-">
                        <span class="num">${cards.number}</span>
                        <input type="button" class="plus" onclick="Plus(${cards.id})" value="+">
                    </div>
                </div>
...
console.log("🚀 ~ file: app.js ~ line 192 ~ number", number)
