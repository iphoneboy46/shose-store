...
function getProductInfo(product,callback){
    let productInfo ={
        image : product.querySelector('#image'),
...
function renderProductCard(cards){
    ...
    var renders = cards.map(function(card){
        return `
    <div class="cart-img col l-4">
        <img src="${card.image}" alt="">
    </div>
    <div class="cart-details col l-7">
        <h2>${card.name}</h2>
        <h3>Price: ${card.price} d</h3>
        <div class="quantity">
