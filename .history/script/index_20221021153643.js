...
var itemQuantityMB = document.querySelector(".card--quantity");
  ...
  if (productInCart.length > 0) {
    ...
    let result = productInCart.map(function (product) {
      return `
            ...
            <div class="cart-img col l-3 c-3">
                <img src="${product.image}" alt="">
            </div>
            <div class="product__quantity" style="display: none">
            <p id="quantity">${product.quantity}</p>
            </div>
            <div class="cart-details col l-6 c-6">
            ...
            <div class="card-delete col l-3 c-3">
...
function updateCartInfo() {
  ...
  itemQuantityMB.textContent = cartInfo.productCount;
