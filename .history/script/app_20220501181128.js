...
function getProductInfo(product){
    ...
    var productNameT = product.querySelectorAll('#name').textContent
    console.log("🚀 ~ file: app.js ~ line 142 ~ getProductInfo ~ productNameT", productNameT)
    let productInfo ={
    ...
    fetch(cardApi,options)
        ...
        .then(function(cards){ 
            ...
            for(var i = 0; i < listCard.length; i++){
                console.log(productNameT);
                if(productNameT[i].textContent == cards.name){
